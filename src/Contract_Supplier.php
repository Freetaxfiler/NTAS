...
TWIG, $twig_params);
        ...
        foreach ($contracts as $data) {
            ...
            if (!isset($entity_cache[$data['entity']])) {
                $entity_cache[$data['entity']] = Dropdown::getDropdownName("ntas_entities", $data['entity']);
            }
            $entry['entity'] = $entity_cache[$data['entity']];

            if (!isset($type_cache[$data['contracttypes_id']])) {
                $type_cache[$data['contracttypes_id']] = Dropdown::getDropdownName("ntas_contracttypes", $data['contracttypes_id']);
            }
...
TWIG, $twig_params);
        ...
        foreach ($suppliers as $data) {
            ...
            if (!isset($type_cache[$data['suppliertypes_id']])) {
                $type_cache[$data['suppliertypes_id']] = Dropdown::getDropdownName("ntas_suppliertypes", $data['suppliertypes_id']);
            }
