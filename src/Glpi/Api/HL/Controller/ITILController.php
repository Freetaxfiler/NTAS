                    ...
                    if ($itil_type !== Ticket::class) {
                        ...
                        $criteria = [
                            'LEFT JOIN' => [
                                'ntas_tickets_users' => [
                                    'ON' => [
                                        'ntas_tickets_users' => Ticket::getForeignKeyField(),
                                        '_' => 'id',
                                    ],
                                ],
                                'ntas_groups_tickets' => [
                                    'ON' => [
                                        'ntas_groups_tickets' => Ticket::getForeignKeyField(),
                                        '_' => 'id',
                                    ],
                                ],
                            ],
                        ...
                        if (Session::haveRight(Ticket::$rightname, CommonITILObject::READMY)) {
                            ...
                            $criteria['WHERE']['OR'][] = [
                                'AND' => [
                                    ...
                                    'ntas_tickets_users' . '.type' => [CommonITILActor::REQUESTER, CommonITILActor::OBSERVER],
                                ],
                            ];
                        }
                        if (!empty($_SESSION['glpigroups']) && Session::haveRight(Ticket::$rightname, Ticket::READGROUP)) {
                            ...
                            $criteria['WHERE']['OR'][] = [
                                'AND' => [
                                    ...
                                    'ntas_groups_tickets.type' => [CommonITILActor::REQUESTER, CommonITILActor::OBSERVER],
                                ],
                            ];
                        }
                        ...
                        if (
                            ...
                            if (count($_SESSION['glpigroups'])) {
                                $criteria['OR'][] = [
                                    'AND' => [
                                        "ntas_ticketvalidations.itemtype_target" => Group::class,
                                        "ntas_ticketvalidations.items_id_target" => $_SESSION['glpigroups'],
                                    ],
                                ];
                            }
                        }
