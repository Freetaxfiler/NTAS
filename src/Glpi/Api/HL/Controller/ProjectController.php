                    ...
                    'read' => static function () {
                        if (!Session::haveRight(Project::$rightname, Project::READALL)) {
                            ...
                            $criteria = [
                                ...
                                'WHERE' => [
                                    'OR' => [
                                        ...
                                        [
                                            "ntas_projectteams.itemtype"   => 'User',
                                            "ntas_projectteams.items_id"   => Session::getLoginUserID(),
                                        ],
                                    ],
                                ],
                            ];
                            if (count($_SESSION['glpigroups'])) {
                                ...
                                $criteria['WHERE']['OR'][] = [
                                    "ntas_projectteams.itemtype"   => 'Group',
                                    "ntas_projectteams.items_id"   => $_SESSION['glpigroups'],
                                ];
                            }
                            return $criteria;
                        }
                ...
                'x-rights-conditions' => [ // Object-level extra permissions
                    'read' => static function () {
                        if (!Session::haveRight(Project::$rightname, Project::READALL)) {
                            ...
                            $criteria = [
                                ...
                                'WHERE' => [
                                    'OR' => [
                                        ...
                                        [
                                            'ntas_projecttaskteams.items_id' => Session::getLoginUserID(),
                            ...
                            if (count($_SESSION['glpigroups'])) {
                                $criteria['WHERE']['OR'][] = [
                                    'ntas_projecttaskteams.items_id' => $_SESSION['glpigroups'],
                                    'ntas_projecttaskteams.itemtype' => 'Group',
                                ];
                            }
                            return $criteria;
                        }
