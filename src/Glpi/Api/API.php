    ...
    protected function getMyEntities($params = [])
    {
        ...
        foreach ($_SESSION['glpiactiveprofile']['entities'] as $entity) {
            if ($entity['is_recursive'] == 1 && $params['is_recursive'] == 1) {
                $sons = getSonsOf('ntas_entities', $entity['id']);
    ...
    protected function getItem($itemtype, $id, $params = [])
    {
        ...
        if (
            ...
            $fs_iterator = $DB->request([
                'SELECT'    => [
                    'ntas_filesystems.name AS fsname',
                    'ntas_items_disks.*',
                ],
                'FROM'      => 'ntas_items_disks',
                'LEFT JOIN'  => [
                    'ntas_filesystems' => [
                        'ON' => [
            ...
            if (!Software::canView()) {
                ...
                $soft_iterator = $DB->request([
                    'SELECT'    => [
                        ...
                        'ntas_softwares.id AS softwares_id',
                        'ntas_softwareversions.id AS softwareversions_id',
                        'ntas_items_softwareversions.is_dynamic',
                        'ntas_softwareversions.states_id',
                        'ntas_softwares.is_valid',
                    ],
                    ...
                    'WHERE'     => [
                        'ntas_items_softwareversions.items_id'   => $id,
        ...
        if (
            ...
            if (!Contract::canView()) {
                ...
                $iterator = $DB->request([
                    ...
                    'WHERE'     => [
                        'ntas_contracts_items.items_id'  => $id,
                        'ntas_contracts_items.itemtype'  => $itemtype,
                    ] + getEntitiesRestrictCriteria('ntas_contracts', '', '', true),
                    'ORDERBY'   => 'ntas_contracts.name',
                ]);
                foreach ($iterator as $data) {
        ...
        if (
            ...
            if (
                ...
                $doc_criteria = [
                    'ntas_documents_items.items_id'  => $id,
                ...
                $doc_iterator = $DB->request([
                    'SELECT'    => [
                        'ntas_documents_items.id AS assocID',
                        'ntas_documents_items.date_creation AS assocdate',
                        'ntas_entities.id AS entityID',
                        'ntas_entities.completename AS entity',
                        'ntas_documentcategories.completename AS headings',
                        'ntas_documents.*',
                    ],
        ...
        if (
            ...
            if (!Ticket::canView()) {
                ...
                $criteria['WHERE'] = [
                    'ntas_items_tickets.items_id' => $id,
        ...
        if (
            ...
            if (!Problem::canView()) {
                ...
                $criteria['WHERE'] = [
                    'ntas_items_problems.items_id' => $id,
        ...
        if (
            ...
            if (!Change::canView()) {
                ...
                $criteria['WHERE'] = [
                    'ntas_changes_items.items_id' => $id,
        ...
        if (!NetworkEquipment::canView()) {
            ...
            foreach ($networkport_types as $networkport_type) {
                ...
                $netp_iterator = $DB->request([
                    ...
                    'FROM'      => 'ntas_networkports AS netp',
                    'LEFT JOIN' => [
                ...
                foreach ($netp_iterator as $data) {
                    if (isset($data['netport_id'])) {
                        ...
                        $netn_iterator = $DB->request([
                            ...
                            'FROM'      => [
                                'ntas_networknames AS netn',
                            ],
                            'LEFT JOIN' => [
                                'ntas_ipaddresses AS ipadr'               => [
                                    'ON' => [
                                        'ipadr'  => 'items_id',
                                        'netn'   => 'id',
                                        [
                                ...
                                'ntas_ipaddresses_ipnetworks AS ipadnet'  => [
                                    'ON' => [
                                        'ipadnet'   => 'ipaddresses_id',
                                        'ipadr'     => 'id',
                                    ],
                                ],
                                'ntas_ipnetworks AS ipnet'                => [
                                    'ON' => [
                                        'ipnet'     => 'id',
