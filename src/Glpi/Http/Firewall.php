...
final class Firewall
{
    ...
    /**
     * @param ?string $ntas_root             GLPI root directory on filesystem
     * @param ?array  $plugin_directories         GLPI plugins root directories on filesystem
     */
    public function __construct(?string $ntas_root = null, ?array $plugin_directories = null)
    {
        $this->ntas_root = $ntas_root ?? GLPI_ROOT;
    ...
    {
        if (!file_exists($this->ntas_root . $path)) {
            // Modern controllers
