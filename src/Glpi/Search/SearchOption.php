    ...
    public static function getOptionsForItemtype($itemtype, $withplugins = true): array
    {
        ...
        switch ($itemtype) {
            case 'Internet':
                ...
                $search[$itemtype][31]['table']         = 'ntas_states';
            ...
            case AllAssets::getType():
                ...
                $search[$itemtype][70]['table']         = 'ntas_users';
                ...
                $search[$itemtype][71]['table']         = 'ntas_groups';
                ...
                $search[$itemtype][49]['table']          = 'ntas_groups';
                ...
                $search[$itemtype][80]['table']         = 'ntas_entities';
