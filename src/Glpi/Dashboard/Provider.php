    ...
    public static function nbTicketsGeneric(
        ...
        switch ($case) {
            ...
            case 'late':
                ...
                $query_criteria['WHERE'][] = [
                    'OR' => [
                        CommonITILObject::generateSLAOLAComputation('time_to_resolve', 'ntas_tickets'),
                        CommonITILObject::generateSLAOLAComputation('internal_time_to_resolve', 'ntas_tickets'),
                        CommonITILObject::generateSLAOLAComputation('time_to_own', 'ntas_tickets'),
                        CommonITILObject::generateSLAOLAComputation('internal_time_to_own', 'ntas_tickets'),
                    ],
                ];
                break;
            ...
            case 'waiting_validation':
                ...
                $where = [
                    'NOT' => ['ntas_tickets.status' => [...Ticket::getSolvedStatusArray(), ...Ticket::getClosedStatusArray()]],
                ...
                // Join ntas_ticketvalidations table if not already done
                if (!isset($query_criteria['LEFT JOIN']['ntas_ticketvalidations'])) {
                    $query_criteria['LEFT JOIN']['ntas_ticketvalidations'] = [
                        'ON' => [
