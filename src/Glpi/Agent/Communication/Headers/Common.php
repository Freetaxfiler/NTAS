...
class Common
{
     ...
     * @var string
     */
    protected string $ntas_agent_id;
     ...
     * @var string
     */
    protected string $ntas_request_id;
     ...
     * @var string
     */
    protected string $ntas_cryptokey_id;
     ...
     * @var string
     */
    protected string $ntas_proxy_id;
    ...
    {
        return [
            'ntas_cryptokey_id' => 'GLPI-CryptoKey-ID',
        ];
    }
