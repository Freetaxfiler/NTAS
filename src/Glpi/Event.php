...
class Event extends CommonDBTM
{
     ...
     * Log an event.
     *
     * Log the event $event on the ntas_event table with all the others args, if
     ...
     * the `type` column in ntas_events.
    ...
    /**
     * Get all itemtypes referenced in the `type` columns of ntas_events
