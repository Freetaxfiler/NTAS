...
class AppliancesPluginToCoreCommand extends AbstractCommand
{
    ...
    public const PLUGIN_APPLIANCE_TABLES = [
        "ntas_plugin_appliances_appliances"       => [
            "id",
            "entities_id",
            "is_recursive",
            "name",
        ...
        "ntas_plugin_appliances_appliancetypes"   => ["id","entities_id","is_recursive","name","comment"],
        "ntas_plugin_appliances_appliances_items" => ["id", "plugin_appliances_appliances_id","items_id","itemtype"],
        "ntas_plugin_appliances_environments"     => ["id","name","comment" ],
        "ntas_plugin_appliances_relations"        => ["id","plugin_appliances_appliances_items_id","relations_id"],
    ];
    ...
    private function createApplianceItems(): bool
    {
        ...
        $iterator = $this->db->request([
            'FROM' => 'ntas_plugin_appliances_appliances_items',
        ]);
    ...
    private function createApplianceEnvironments(): bool
    {
        ...
        $iterator = $this->db->request([
            'FROM' => 'ntas_plugin_appliances_environments',
        ]);
    ...
    private function createAppliances(): bool
    {
        ...
        $iterator = $this->db->request([
            'FROM' => 'ntas_plugin_appliances_appliances',
        ]);
    ...
    private function createApplianceTypes(): bool
    {
        ...
        $iterator = $this->db->request([
            'FROM' => 'ntas_plugin_appliances_appliancetypes',
        ]);
    ...
    private function createApplianceRelations(): bool
    {
        ...
        $iterator = $this->db->request([
            ...
            'FROM'         => 'ntas_plugin_appliances_relations AS rel',
            'INNER JOIN'   => [
                'ntas_plugin_appliances_appliances_items AS items' => [
                    'ON'  => [
                        'items' => 'id',
                        'rel'   => 'plugin_appliances_appliances_items_id',
                    ],
                ],
                'ntas_plugin_appliances_appliances AS app' => [
                    'ON'  => [
                        'app'   => 'id',
