...
class DatabasesPluginToCoreCommand extends AbstractPluginToCoreCommand
{
    ...
    {
        return [
            'ntas_plugin_databases_databases.id',
            'ntas_plugin_databases_databases.entities_id',
            'ntas_plugin_databases_databases.is_recursive',
            'ntas_plugin_databases_databases.name',
            'ntas_plugin_databases_databases.is_deleted',
            'ntas_plugin_databases_databases.plugin_databases_databasetypes_id',
            'ntas_plugin_databases_databases.plugin_databases_databasecategories_id',
            'ntas_plugin_databases_databases.comment',
            'ntas_plugin_databases_databases.locations_id',
            'ntas_plugin_databases_databases.manufacturers_id',
            'ntas_plugin_databases_databases.suppliers_id',
            'ntas_plugin_databases_databases.users_id',
            'ntas_plugin_databases_databases.groups_id',
            'ntas_plugin_databases_databases.date_mod',
            'ntas_plugin_databases_databases.is_helpdesk_visible',

            'ntas_plugin_databases_instances.id',
            'ntas_plugin_databases_instances.entities_id',
            'ntas_plugin_databases_instances.is_recursive',
            'ntas_plugin_databases_instances.name',
            'ntas_plugin_databases_instances.plugin_databases_databases_id',

            'ntas_plugin_databases_databasetypes.id',
            'ntas_plugin_databases_databasetypes.name',
            'ntas_plugin_databases_databasetypes.comment',

            'ntas_plugin_databases_databasecategories.id',
            'ntas_plugin_databases_databasecategories.name',
            'ntas_plugin_databases_databasecategories.comment',
        ];
    }
    ...
    private function importDatabaseInstanceCategories(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'ntas_plugin_databases_databasecategories',
            'ORDER' => 'id ASC',
        ]);
    ...
    private function importDatabases(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'ntas_plugin_databases_instances', // Database in GLPI core corresponds to PluginDatabasesInstance
            'ORDER' => 'id ASC',
        ]);
    ...
    private function importDatabaseInstances(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'ntas_plugin_databases_databases', // Database in GLPI core corresponds to PluginDatabasesDatabase
            'ORDER' => 'id ASC',
        ]);
        ...
        foreach ($progress_bar->iterate($iterator) as $instance_data) {
            ...
            //try to load related item from 'ntas_plugin_databases_databases_items'
            $related_item_iterator = $this->db->request([
                'FROM'  => 'ntas_plugin_databases_databases_items',
                'WHERE' => [
    ...
    private function importDatabaseInstanceTypes(): void
    {
        ...
        $iterator = $this->db->request([
            'FROM'  => 'ntas_plugin_databases_databasetypes',
            'ORDER' => 'id ASC',
        ]);
