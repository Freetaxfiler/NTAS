    ...
    public function getMissingKeys(string $table_name): array
    {
        ...
        foreach ($columns as $column_name) {
            ...
            if (
                ...
                $ignored_fields = [
                    'ntas_ipaddresses.mainitems_id', // FIXME Should be renamed to ntas_ipaddresses.items_id_main to fit naming conventions.
                    'ntas_networkportaggregates.networkports_id_list', // FIXME Should be replaced by a relation table.
                    'ntas_planningexternalevents.users_id_guests', // FIXME Should be replaced by a relation table.
                    'ntas_dashboards_items.card_id', // FIXME This is not a foreign key.
                    'ntas_dashboards_items.gridstack_id', // FIXME This is not a foreign key.
                ];
