...
class TemplateRenderer
{
    ...
    public function __construct(string $rootdir = GLPI_ROOT, ?string $cachedir = null)
    {
        ...
        $ntas_environment = GLPIEnvironment::get();
        $env_params = [
            'debug' => $ntas_environment->shouldEnableExtraDevAndDebugTools() || ($_SESSION['ntas_use_mode'] ?? null) === Session::DEBUG_MODE,
            'auto_reload' => $ntas_environment->shouldExpectResourcesToChange(),
