...
class Budget extends CommonDropdown
{
    ...
    private function getItemListCriteria(bool $entity_restrict = true): QueryUnion
    {
        ...
        $itemtypes = [
            // These types shouldn't be in the ntas_infocoms table, but have their costs elsewhere
        ...
        foreach ($infocom_itemtypes as $itemtype) {
            ...
            $criteria = [
                ...
                'WHERE'        => [
                    ...
                    'ntas_infocoms.budgets_id'          => $budgets_id,
                ],
                'ORDERBY'      => [
                    $item_table . '.entities_id',
                ],
            ...
            $criteria['SELECT'][] = 'ntas_infocoms.value';
