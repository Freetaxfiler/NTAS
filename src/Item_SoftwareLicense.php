                ...
                if (isset($input['options'])) {
                    if (isset($input['options']['move'])) {
                        SoftwareLicense::dropdown([
                            'condition' => [
                                'ntas_softwarelicenses.softwares_id' => $input['options']['move']['softwares_id'],
                            ],
            ...
            $request = [
                ...
                'INNER JOIN'   => [
                    $itemtable  => [
                        'FKEY'   => [
                            $itemtable                    => 'id',
                            'ntas_items_softwarelicenses' => 'items_id', [
                                'AND' => [
                                    'ntas_items_softwarelicenses.itemtype' => $taget_itemtype,
                                ],
                            ],
                        ],
                    ],
                ...
                'WHERE'        => [
                    'ntas_items_softwarelicenses.softwarelicenses_id'     => $softwarelicenses_id,
                    'ntas_items_softwarelicenses.is_deleted'              => 0,
                ],
            ];
            if ($entity !== -1) {
    ...
    public static function countForSoftware($softwares_id)
    {
        ...
        foreach ($target_types as $itemtype) {
            ...
            $request = [
                ...
                'WHERE'        => [
                    'ntas_softwarelicenses.softwares_id'      => $softwares_id,
                    'ntas_items_softwarelicenses.is_deleted'  => 0,
    ...
    public static function showForLicense(SoftwareLicense $license): bool
    {
        ...
        if (
            ...
            $entity_restrict = $license->fields['is_recursive']
                    ? getSonsOf('ntas_entities', $license->fields['entities_id'])
...
JAVASCRIPT;
        ...
        foreach ($CFG_GLPI['software_types'] as $itemtype) {
            ...
            $query = [
                'SELECT' => [
                    $item_license_table . '.*',
                    'ntas_softwarelicenses.name AS license',
                    'ntas_softwarelicenses.id AS vID',
                    'ntas_softwarelicenses.softwares_id AS softid',
                ...
                'WHERE'     => [
                    'ntas_softwarelicenses.id'                   => $searchID,
                    'ntas_items_softwarelicenses.is_deleted'     => 0,
                ],
            ];
    ...
    public static function getLicenseForInstallation($itemtype, $items_id, $softwareversions_id)
    {
        ...
        $iterator = $DB->request([
            ...
            'WHERE'        => [
                ...
                'OR'                                => [
                    'ntas_softwarelicenses.softwareversions_id_use' => $softwareversions_id,
                    'ntas_softwarelicenses.softwareversions_id_buy' => $softwareversions_id,
                ],
            ],
        ]);
    ...
    public static function countLicenses($softwares_id)
    {
        ...
        $result = $DB->request([
            ...
            'WHERE'  => [
                'softwares_id' => $softwares_id,
            ] + getEntitiesRestrictCriteria('ntas_softwarelicenses'),
        ])->current();
        return $result['cpt'];
    }
}
