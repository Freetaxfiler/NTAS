...
class Toolbox
{
    ...
    public static function testWriteAccessToDirectory($dir)
    {
        ...
        $sdir = sprintf("%s/test_ntas_%08x", $dir, $rand);
        ...
        // Check file creation
        $path = sprintf("%s/test_ntas_%08x.txt", $dir, $rand);
        $fp   = fopen($path, 'w');
    ...
    public static function createSchema($lang = 'en_GB', ?DBmysql $database = null, ?AbstractProgressIndicator $progress_indicator = null)
    {
        ...
        foreach ($tables as $table => $data) {
            // Enable NO_AUTO_VALUE_ON_ZERO for ntas_entities insertion (needed for id=0 root entity)
            ...
            try {
                ...
                // Restore original SQL mode after ntas_entities insertion
