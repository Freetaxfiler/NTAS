...
class RuleRight extends Rule
{
    ...
    public function getCriterias()
    {
        ...
        if (!count($criterias)) {
            ...
            $criterias['LDAP_SERVER']['table']     = 'ntas_authldaps';
            ...
            $criterias['MAIL_SERVER']['table']     = 'ntas_authmails';
            ...
            $criterias['_groups_id']['table']      = 'ntas_groups';
    ...
    public function getActions()
    {
        ...
        $actions['entities_id']['table']                      = 'ntas_entities';
        ...
        $actions['profiles_id']['table']                      = 'ntas_profiles';
        ...
        $actions['_entities_id_default']['table']             = 'ntas_entities';
        ...
        $actions['specific_groups_id']['table'] = 'ntas_groups';
        ...
        $actions['_profiles_id_default']['table']             = 'ntas_profiles';
    ...
    public function addSpecificCriteriasToArray(array &$criteria): void
    {
        ...
        $all = getAllDataFromTable('ntas_rulerightparameters', [], true);
        foreach ($all as $data) {
