...
class RuleAsset extends Rule
{
    ...
    public function getCriterias()
    {
        ...
        $criterias['states_id']['table']            = 'ntas_states';
        ...
        $criterias['users_id']['table']           = 'ntas_users';

        $criterias['_tag']['name']            = sprintf('%s > %s', Agent::getTypeName(1), __('Inventory tag'));

        $criterias['_locations_id_of_user']['table']     = 'ntas_locations';
        ...
        $criterias['_groups_id_of_user']['table']        = 'ntas_groups';
    ...
    public function getActions()
    {
        ...
        $actions['states_id']['table']          = 'ntas_states';
        ...
        $actions['users_id']['table']           = 'ntas_users';
        ...
        $actions['groups_id_tech']['table']     = 'ntas_groups';
