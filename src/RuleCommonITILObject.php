...
TWIG, ['message' => __('An action related to an approval exists, but there is no action assigning the approval validation step. Therefore, the default one will be used.')]);
    ...
    public function getCriterias()
    {
        ...
        $criterias['itilcategories_id']['table']              = 'ntas_itilcategories';
        ...
        $criterias['_users_id_requester']['table']            = 'ntas_users';
        ...
        $criterias['_groups_id_of_requester']['table']        = 'ntas_groups';
        ...
        $criterias['_groups_id_of_item']['table']             = 'ntas_groups';
        ...
        $criterias['_states_id_of_item']['table']             = 'ntas_states';
        ...
        $criterias['_groups_id_requester']['table']           = 'ntas_groups';
        ...
        $criterias['_users_id_assign']['table']               = 'ntas_users';
        ...
        $criterias['_groups_id_assign']['table']              = 'ntas_groups';
        ...
        $criterias['_suppliers_id_assign']['table']           = 'ntas_suppliers';
        ...
        $criterias['_users_id_observer']['table']             = 'ntas_users';
        ...
        $criterias['_groups_id_observer']['table']            = 'ntas_groups';
        ...
        $criterias['requesttypes_id']['table']                = 'ntas_requesttypes';
        ...
        $criterias['profiles_id']['table']                    = 'ntas_profiles';
        ...
        // Itil object supporting validation/approval
    ...
    public function getActions()
    {
        ...
        $actions['itilcategories_id']['table']                      = 'ntas_itilcategories';
        ...
        $actions['_itilcategories_id_by_completename']['table']                = 'ntas_itilcategories';
        ...
        $actions['_groups_id_requester']['table']                   = 'ntas_groups';
        ...
        $actions['_groups_id_requester_by_completename']['table']             = 'ntas_groups';
        ...
        $actions['_groups_id_assign']['table']                      = 'ntas_groups';
        ...
        $actions['_groups_id_assign_by_completename']['table']                = 'ntas_groups';
        ...
        // set a supplier
        $actions['_suppliers_id_assign']['table']                   = 'ntas_suppliers';
        ...
        $actions['_groups_id_observer']['table']                    = 'ntas_groups';
        ...
        $actions['_groups_id_observer_by_completename']['table']              = 'ntas_groups';
        ...
        $actions['assign_appliance']['table']                       = 'ntas_appliances';
        ...
        if (static::getItemtype()::getValidationClassInstance() !== null) {
            ...
            $actions['validationsteps_id']['table']                     = 'ntas_validationsteps';
        ...
        $actions['requesttypes_id']['table']                        = 'ntas_requesttypes';
        ...
        $actions['solution_template']['table']                      = 'ntas_solutiontemplates';
