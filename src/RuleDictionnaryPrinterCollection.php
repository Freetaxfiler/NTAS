    ...
    private function getIteratorCriteriaForRulesReplay(): array
    {
        ...
        return [
            'SELECT' => [
                ...
                'ntas_printers.manufacturers_id AS manufacturers_id',
                'ntas_printers.comment AS comment',
            ],
            'DISTINCT'  => true,
            'FROM'      => 'ntas_printers',
            'LEFT JOIN' => [
            ...
            'WHERE'     => [
                ...
                'ntas_printers.is_deleted'    => 0,
                'ntas_printers.is_template'   => 0,
            ],
        ];
    }
    ...
    public function replayDictionnaryOnPrintersByID(array $IDs, $res_rule = [])
    {
        ...
        $iterator = $DB->request([
            'SELECT'    => [
                'ntas_printers.id',
                'ntas_printers.name',
                'ntas_printers.entities_id AS entities_id',
                'ntas_printers.is_global AS is_global',
                'ntas_manufacturers.name AS manufacturer',
            ],
            'FROM'      => 'ntas_printers',
            'LEFT JOIN' => [
