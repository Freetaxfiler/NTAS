    ...
    public static function searchNetworks(
        ...
        switch ($relation) {
            case "is contained by":
                ...
                if ($recursive) {
                    $entitiesID = getSonsOf('ntas_entities', $entityID);
                }
                break;
            ...
            case "contains":
                ...
                if ($recursive) {
                    $entitiesID = getAncestorsOf('ntas_entities', $entityID);
                }
                break;

            case "equals":
                if ($recursive) {
                    $entitiesID = getSonsAndAncestorsOf('ntas_entities', $entityID);
                }
                break;
        }
