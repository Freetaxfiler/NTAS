...
class DeviceHardDrive extends CommonDevice
{
    ...
    public function rawSearchOptions()
    {
        ...
        $tab[] = [
            'id'                 => '15',
            'table'              => 'ntas_deviceharddrivemodels',
            'field'              => 'name',
        ...
        $tab[] = [
            'id'                 => '17',
            'table'              => 'ntas_deviceharddrivetypes',
            'field'              => 'name',
            ...
            case 'Computer':
                ...
                if ($this->fields["deviceharddrivetypes_id"]) {
                    $row->addCell(
                        ...
                        htmlescape(Dropdown::getDropdownName("ntas_deviceharddrivetypes", $this->fields["deviceharddrivetypes_id"])),
                        $father
                    );
                }
    ...
    public static function rawSearchOptionsToAdd($itemtype, $main_joinparams)
    {
        ...
        $tab[] = [
            ...
            'joinparams'         => [
                'beforejoin'         => [
                    'table'              => 'ntas_items_deviceharddrives',
