...
TWIG, $twig_params);
        ...
        $networknames = $DB->request([
            ...
            'WHERE' => [
                ...
                'ntas_networknames.is_dynamic' => 1,
                'ntas_networknames.is_deleted' => 1,
        ...
        $ipaddresses = $DB->request([
            ...
            'WHERE' => [
                'ntas_networkports.items_id'  => $ID,
                'ntas_ipaddresses.is_dynamic' => 1,
                'ntas_ipaddresses.is_deleted' => 1,
    ...
    private static function getLocksQueryInfosByItemType($itemtype, $baseitemtype)
    {
        ...
        switch ($itemtype) {
            ...
            case 'NetworkName':
                    ...
                    'INNER JOIN' => [
                        'ntas_networkports' => [
                            'ON' => [
                                ...
                                'ntas_networkports' => 'id', [
                                    'AND' => [
                                        'ntas_networkports.itemtype'  => $baseitemtype,
                                    ],
                                ],
                            ],
                        ],
                ...
                $field     = 'ntas_networkports.items_id';
                break;

            case 'IPAddress':
                $criteria = [
                    'SELECT' => ['ntas_ipaddresses.id'],
            ...
            case 'SoftwareVersion':
                $criteria = [
                    'SELECT' => ['ntas_items_softwareversions.id'],
