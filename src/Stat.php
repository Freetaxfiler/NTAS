...
class Stat extends CommonGLPI
{
        ...
        switch ($type) {
            ...
            case 'groups_tree_assign':
                ...
                $iterator = $DB->request([
                    ...
                    'WHERE'  => [
                        ...
                        $is_field   => 1,
                    ] + getEntitiesRestrictCriteria("ntas_groups", '', '', true),
                    'ORDER'  => 'completename',
                ]);
            ...
            case "itilcategories_id":
                ...
                $criteria = [
                    'SELECT'    => [
                        ...
                        'ntas_itilcategories.' . ($is_tree ? 'name' : 'completename') . ' AS category',
                    ],
                    'DISTINCT'  => true,
                    'FROM'      => 'ntas_itilcategories',
                    'WHERE'     => getEntitiesRestrictCriteria('ntas_itilcategories', '', '', true),
            ...
            case 'locations_id':
                ...
                $criteria = [
                    'SELECT'    => [
                        'ntas_locations.id',
                        'ntas_locations.' . ($is_tree ? 'name' : 'completename') . ' AS location',
                    ],
                    'DISTINCT'  => true,
                    'FROM'      => 'ntas_locations',
                    'WHERE'     => getEntitiesRestrictCriteria('ntas_locations', '', '', true),
                    'ORDERBY'   => 'completename',
                ];
    ...
    public static function showTable($itemtype, $type, $date1, $date2, $start, array $value, $value2 = '')
    {
        ...
        $subname = match ($type) {
            'group_tree', 'groups_tree_assign' => Dropdown::getDropdownName('ntas_groups', $value2),
            'itilcategories_tree' => Dropdown::getDropdownName('ntas_itilcategories', $value2),
            'locations_tree' => Dropdown::getDropdownName('ntas_locations', $value2),
            default => '',
        };
    ...
    public static function constructEntryValues(
        ...
        switch ($param) {
            ...
            case "usertitles_id":
                ...
                $WHERE["ntas_users.usertitles_id"] = $value;
                $WHERE["$userlinktable.type"] = CommonITILActor::REQUESTER;
                break;
            ...
            case "usercategories_id":
                ...
                $WHERE["ntas_users.usercategories_id"] = $value;
                $WHERE["$userlinktable.type"] = CommonITILActor::REQUESTER;
                break;
            ...
            case "itilcategories_tree":
                if ($value == $value2) {
                    ...
                    $categories = getSonsOf("ntas_itilcategories", (int) $value);
                }
            ...
            case 'locations_tree':
                if ($value == $value2) {
                    ...
                    $locations = getSonsOf('ntas_locations', (int) $value);
                }
            ...
            case 'groups_tree_assign':
                ...
                if ($value == $value2) {
                    ...
                    $groups = getSonsOf("ntas_groups", (int) $value);
                }
            ...
            case "solutiontypes_id":
                $LEFTJOIN = [
                    'ntas_itilsolutions' => [
                        'ON' => [
                            'ntas_itilsolutions'   => 'items_id',
                            'ntas_tickets'               => 'id', [
                                'AND' => [
                                    'ntas_itilsolutions.itemtype' => Ticket::class,
                                ],
                            ],
                        ],
                    ],
                ];
                $WHERE["ntas_itilsolutions.$param"] = $value;
                break;
            ...
            case "device":
                ...
                $WHERE["ntas_computers.is_template"] = 0;
                break;
            ...
            case "comp_champ":
                ...
                if (str_starts_with($champ, 'operatingsystem')) {
                    $INNERJOIN['ntas_items_operatingsystems'] = [
                        'ON' => [
                            'ntas_computers'              => 'id',
                            'ntas_items_operatingsystems' => 'items_id', [
                                'AND' => [
                                    "ntas_items_operatingsystems.itemtype" => 'Computer',
                                ],
                            ],
                        ],
                    ];
                    $WHERE["ntas_items_operatingsystems.$champ"] = $value;
                } else {
                    $WHERE["ntas_computers.$champ"] = $value;
                }
                break;
        }
        ...
        switch ($type) {
            ...
            case "inter_opensatisfaction":
                ...
                $INNERJOIN['ntas_ticketsatisfactions'] = [
                    'ON' => [
            ...
            case "inter_answersatisfaction":
                ...
                $WHERE[] = [
                    ...
                    ['NOT' => ["ntas_ticketsatisfactions.date_answered"  => null]],
                ];
            ...
            case "inter_avgsatisfaction":
                ...
                $criteria = [
                    'SELECT'    => [
                        $closedate_unix,
                        'AVG'  => "ntas_ticketsatisfactions.satisfaction_scaled_to_5 AS total_visites",
                    ],
                    'FROM'      => $table,
                    'WHERE'     => $WHERE,
                    'GROUPBY'   => 'date_unix',
    ...
    public static function getAssetsWithITIL($start_date, $end_date, $itil_type = Ticket::class): array
    {
        ...
        if ($view_entities) {
            $entities = getAllDataFromTable('ntas_entities');
        }
