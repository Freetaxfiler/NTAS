...
class NotificationTargetChange extends NotificationTargetCommonITILObject
{
    ...
    public function getDataForObject(CommonDBTM $item, array $options, $simple = false)
    {
        ...
        if (!$simple) {
            ...
            $tickets  = getAllDataFromTable('ntas_changes_tickets', $restrict);
            ...
            $problems = getAllDataFromTable('ntas_changes_problems', $restrict);
            ...
            $items    = getAllDataFromTable('ntas_changes_items', $restrict);
            ...
            //Validation infos
            if (isset($options['validation_id']) && $options['validation_id']) {
                $restrict['ntas_changevalidations.id'] = $options['validation_id'];
            }
