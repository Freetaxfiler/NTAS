...
class Item_OperatingSystem extends CommonDBRelation
{
    ...
    public static function getFromItem(CommonDBTM $item, $sort = null, $order = null): DBmysqlIterator
    {
        ...
        if ($sort === null) {
            $sort = "ntas_items_operatingsystems.id";
        }
        if ($order === null) {
            $order = 'ASC';
        }
        ...
        $iterator = $DB->request([
            'SELECT'    => [
                'ntas_items_operatingsystems.id AS assocID',
                'ntas_operatingsystems.name',
                'ntas_operatingsystemversions.name AS version',
                'ntas_operatingsystemarchitectures.name AS architecture',
                'ntas_operatingsystemservicepacks.name AS servicepack',
            ],
            ...
            'LEFT JOIN' => [
                ...
                'ntas_operatingsystemservicepacks'  => [
                    'ON' => [
                        ...
                        'ntas_operatingsystemservicepacks'  => 'id',
                    ],
                ],
                'ntas_operatingsystemarchitectures' => [
                    'ON' => [
                        'ntas_items_operatingsystems'       => 'operatingsystemarchitectures_id',
                        'ntas_operatingsystemarchitectures' => 'id',
                    ],
                ],
                'ntas_operatingsystemversions'      => [
                    'ON' => [
                        'ntas_items_operatingsystems'    => 'operatingsystemversions_id',
                        'ntas_operatingsystemversions'   => 'id',
                    ],
                ],
            ],
            'WHERE'     => [
                'ntas_items_operatingsystems.itemtype' => $item->getType(),
                'ntas_items_operatingsystems.items_id' => $item->getID(),
            ],
            'ORDERBY'   => "$sort $order",
        ]);
        return $iterator;
    ...
    public static function rawSearchOptionsToAdd($itemtype)
    {
        ...
        $tab[] = [
            ...
            'joinparams'         => [
                'beforejoin'         => [
                    'table'              => 'ntas_items_operatingsystems',
                    'joinparams'         => [
        ...
        $tab[] = [
            'id'                 => '46',
            'table'              => 'ntas_operatingsystemversions',
            'field'              => 'name',
        ...
        $tab[] = [
            'id'                 => '41',
            'table'              => 'ntas_operatingsystemservicepacks',
            'field'              => 'name',
        ...
        $tab[] = [
            'id'                 => '61',
            'table'              => 'ntas_operatingsystemarchitectures',
            'field'              => 'name',
        ...
        $tab[] = [
            'id'                 => '64',
            'table'              => 'ntas_operatingsystemkernels',
            'field'              => 'name',
            ...
            'joinparams'         => [
                'beforejoin'         => [
                    'table'              => 'ntas_operatingsystemkernelversions',
                    'joinparams'         => [
                        'beforejoin'   => [
                            'table'        => 'ntas_items_operatingsystems',
                            'joinparams'   => [
        ...
        $tab[] = [
            'id'                 => '63',
            'table'              => 'ntas_operatingsystemeditions',
            'field'              => 'name',
