...
class NotificationTargetProjectTask extends NotificationTarget
{
    ...
    public function addDataForTemplate($event, $options = [])
    {
        ...
        $this->data["##projecttask.project##"]
                  = Dropdown::getDropdownName('ntas_projects', $item->getField('projects_id'));
        ...
        $items    = getAllDataFromTable('ntas_projecttaskteams', $restrict);
        ...
        // Tickets infos
        $tickets  = getAllDataFromTable('ntas_projecttasks_tickets', $restrict);
        ...
        $iterator = $DB->request([
            ...
            'WHERE'     => [
                'ntas_documents_items.itemtype'  => 'ProjectTask',
