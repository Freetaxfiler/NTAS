...
class NotificationTemplate extends CommonDBTM
{
    ...
    public function getTemplateByLanguage(
        ...
        if (!isset($this->templates_by_languages[$tid])) {
            ...
            $bak_dropdowntranslations = ($_SESSION['ntas_dropdowntranslations'] ?? null);
            $_SESSION['ntas_dropdowntranslations'] = DropdownTranslation::getAvailableTranslations($language);
            ...
            try {
                ...
                if ($bak_dropdowntranslations !== null) {
                    $_SESSION['ntas_dropdowntranslations'] = $bak_dropdowntranslations;
                } else {
                    unset($_SESSION['ntas_dropdowntranslations']);
                }
