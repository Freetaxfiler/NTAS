...
class NotificationTargetProblem extends NotificationTargetCommonITILObject
{
    ...
    public function getDataForObject(CommonDBTM $item, array $options, $simple = false)
    {
        ...
        if (!$simple) {
            ...
            $tickets  = getAllDataFromTable('ntas_problems_tickets', $restrict);
            ...
            $changes  = getAllDataFromTable('ntas_changes_problems', $restrict);
            ...
            $items    = getAllDataFromTable('ntas_items_problems', $restrict);
