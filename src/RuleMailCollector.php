...
class RuleMailCollector extends Rule
{
    ...
    public function getCriterias()
    {
        ...
        $criterias['mailcollector']['table']            = 'ntas_mailcollectors';
        ...
        $criterias['KNOWN_DOMAIN']['table']             = 'ntas_entities';
        ...
        $criterias['PROFILES']['table']                 = 'ntas_profiles';
        ...
        if (Session::isMultiEntitiesMode()) {
            ...
            $criterias['UNIQUE_PROFILE']['table']           = 'ntas_profiles';
