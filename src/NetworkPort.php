...
class NetworkPort extends CommonDBChild
{
    ...
    public function updateMetrics()
    {
        $unicity_input = [
            ...
            'date'            => date('Y-m-d', strtotime($_SESSION['ntas_currenttime'])),
        ];
        $input = array_merge(
            [
    ...
    public static function showForItem(CommonDBTM $item, $withtemplate = 0)
    {
        ...
        foreach ($aggegate_iterator as $row) {
            $port_iterator = $DB->request([
                'FROM'   => 'ntas_networkportaggregates',
    ...
    public static function rawSearchOptionsToAdd($itemtype = null)
    {
        ...
        $networkNameJoin = ['jointype'          => 'itemtype_item',
            ...
            'beforejoin'        => ['table'      => 'ntas_networkports',
                'joinparams' => $joinparams,
            ],
        ];
