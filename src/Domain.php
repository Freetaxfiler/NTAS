                        ...
                        'FKEY'   => [
                            ...
                            [
                                'AND' => [
                                    ...
                                    'ntas_alerts.type'     => $alert_type,
                                ],
                            ],
                        ],
                    ],
                ];
                $query['WHERE'][]   = ['ntas_alerts.date' => null];
