...
class RuleTicket extends RuleCommonITILObject
{
    ...
    public function getCriterias()
    {
        ...
        $criterias['type']['table']                           = 'ntas_tickets';
        ...
        $criterias['_mailgate']['table']                      = 'ntas_mailcollectors';
        ...
        $criterias['slas_id_ttr']['table']                    = 'ntas_slas';
        ...
        $criterias['slas_id_ttr']['condition']                = ['ntas_slas.type' => SLM::TTR];

        $criterias['slas_id_tto']['table']                    = 'ntas_slas';
        ...
        $criterias['slas_id_tto']['condition']                = ['ntas_slas.type' => SLM::TTO];

        $criterias['olas_id_ttr']['table']                    = 'ntas_olas';
        ...
        $criterias['olas_id_ttr']['condition']                = ['ntas_olas.type' => SLM::TTR];

        $criterias['olas_id_tto']['table']                    = 'ntas_olas';
        ...
        $criterias['olas_id_tto']['condition']                = ['ntas_olas.type' => SLM::TTO];

        $criterias['_locations_id_of_requester']['table']     = 'ntas_locations';
        ...
        $criterias['_locations_id_of_item']['table']          = 'ntas_locations';
        ...
        $criterias['locations_id']['table']                   = 'ntas_locations';
        ...
        $criterias['_locations_code']['table']              = 'ntas_locations';
    ...
    public function getActions()
    {
        ...
        $actions['type']['table']                             = 'ntas_tickets';
        ...
        $actions['assign_project']['table']                 = 'ntas_projects';
        ...
        // assign sla ttr
        $actions['slas_id_ttr']['table']                      = 'ntas_slas';
        ...
        $actions['slas_id_ttr']['condition']                  = ['ntas_slas.type' => SLM::TTR];
        ...
        $actions['slas_id_tto']['table']                      = 'ntas_slas';
        ...
        $actions['slas_id_tto']['condition']                  = ['ntas_slas.type' => SLM::TTO];
        ...
        $actions['olas_id_ttr']['table']                      = 'ntas_olas';
        ...
        $actions['olas_id_ttr']['condition']                  = ['ntas_olas.type' => SLM::TTR];
        ...
        $actions['olas_id_tto']['table']                      = 'ntas_olas';
        ...
        $actions['olas_id_tto']['condition']                  = ['ntas_olas.type' => SLM::TTO];
        ...
        $actions['locations_id']['table']                           = 'ntas_locations';
        ...
        $actions['assign_contract']['table']                 = 'ntas_contracts';
