...
class DropdownTranslation extends CommonDBChild
{
    ...
    {
        // Add to session
        $_SESSION['ntas_dropdowntranslations'][$this->fields['itemtype']][$this->fields['field']]
            = $this->fields['field'];
...
TWIG, $twig_params);
    ...
    public static function getTranslatedValue($ID, $itemtype, $field = 'name', $language = '', $value = '')
    {
        ...
        $translated_fields = $language === $_SESSION['glpilanguage'] && isset($_SESSION['ntas_dropdowntranslations'])
            ? $_SESSION['ntas_dropdowntranslations']
