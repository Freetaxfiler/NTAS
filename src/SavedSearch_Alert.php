...
class SavedSearch_Alert extends CommonDBChild
{
    ...
    public static function cronSavedSearchesAlerts($task)
    {
        ...
        $iterator = $DB->request([
            ...
            'LEFT JOIN' => [
                'ntas_alerts' => [
                    'FKEY'   => [
                        ...
                        'ntas_savedsearches_alerts'  => 'id',
                        [
                            'AND' => [
                                'ntas_alerts.itemtype' => SavedSearch_Alert::class,
                                'ntas_alerts.type'     => Alert::PERIODICITY,
                            ],
                        ],
                    ],
                ],
            ...
            'WHERE'     => [
                'ntas_savedsearches_alerts.is_active' => true,
                'OR' => [
                    ...
                    [
                        'ntas_alerts.date' => ['<',
                            QueryFunction::dateSub(
                                ...
                                interval: new QueryExpression($DB::quoteName('ntas_savedsearches_alerts.frequency')),
