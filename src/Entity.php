    ...
    DefaultSearchRequestInterface
{
    ...
    public function prepareInputForAdd($input)
    {
        ...
        $input['max_closedate'] = $_SESSION["ntas_currenttime"];
    ...
    private function handleSatisfactionSurveyConfigOnUpdate(array $input): array
    {
        foreach (['', '_change'] as $suffix) {
            ...
            if (
                ...
                $input[$max_key] = $_SESSION['ntas_currenttime'];
            }
    ...
    public static function showInventoryOptions(Entity $entity): bool
    {
        ...
        $states = getAllDataFromTable('ntas_states');
        ...
        if ($ID > 0) {
            ...
            foreach (getAncestorsOf('ntas_entities', $entity->fields['entities_id']) as $ent) {
        ...
        switch ($field) {
                            ...
                            if ($type === Infocom::ON_STATUS_CHANGE) {
                                ...
                                return htmlescape(
                                    sprintf(
                                        ...
                                        Dropdown::getDropdownName(table: 'ntas_states', id: (int) $sid, default: __('None'))
                                    )
                                );
                            }
                        }
            ...
            case 'entities_id_software':
                ...
                return match ($strategy) {
                    ...
                    default => htmlescape(Dropdown::getDropdownName(table: 'ntas_entities', id: $values[$field], default: __('None'))),
                };
            ...
            case 'calendars_id':
                ...
                return match ($strategy) {
                    ...
                    default => htmlescape(Dropdown::getDropdownName(table: 'ntas_calendars', id: $values[$field], default: __('None'))),
                };
            ...
            case 'transfers_id':
                ...
                return match (true) {
                    ...
                    default => htmlescape(Dropdown::getDropdownName(table: 'ntas_transfers', id: $values[$field], default: __('None'))),
                };
            ...
            case 'contracts_id_default':
                ...
                return match ($strategy) {
                    ...
                    default => htmlescape(Dropdown::getDropdownName(table: 'ntas_contracts', id: $values[$field], default: __('None'))),
                };
    ...
    public static function getEntityTree(int $entities_id_root): array
    {
        ...
        $sons = getSonsOf('ntas_entities', $entities_id_root);
        ...
        return [
            $entities_id_root => [
                'name' => Dropdown::getDropdownName('ntas_entities', $entities_id_root),
                'tree' => $constructed,
            ],
        ];
    }
    ...
    public static function getEntitySelectorTree($rand = 0): array
    {
        ...
        $ancestors = getAncestorsOf('ntas_entities', $_SESSION['glpiactive_entity']);
