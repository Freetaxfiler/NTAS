...
class Document extends CommonDBTM implements TreeBrowseInterface
{
    ...
    private function canViewFileFromReminder()
    {
        ...
        $criteria = array_merge_recursive(
            [
                ...
                'LEFT JOIN' => [
                    'ntas_reminders'  => [
                        'ON' => [
                            ...
                            'ntas_reminders'        => 'id', [
                                'AND' => [
                                    'ntas_documents_items.itemtype'  => 'Reminder',
                                ],
                            ],
                        ],
                    ],
                ...
                'WHERE'     => [
                    'ntas_documents_items.documents_id' => $this->fields['id'],
                ],
            ],
            ...
            'INNER JOIN' => [
                'ntas_knowbaseitems' => [
                    'FKEY' => [
                        ...
                        'ntas_documents_items' => 'items_id',
                        ['AND' => ['ntas_documents_items.itemtype' => 'KnowbaseItem']],
                    ],
                ],
            ],
            'WHERE'     => [
    ...
    public static function dropdown($options = [])
    {
        ...
        $subwhere = [
            'ntas_documents.is_deleted'   => 0,
        ] + getEntitiesRestrictCriteria('ntas_documents', '', $p['entity'], true);
