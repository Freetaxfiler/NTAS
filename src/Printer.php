    ...
    public function canUnrecurs()
    {
        ...
        foreach ($tabend as $enda => $endb) {
            $criteria = [
                ...
                'FROM'         => 'ntas_networkports_networkports',
                'INNER JOIN'   => [
                    'ntas_networkports'  => [
                        'ON'  => [
                            'ntas_networkports_networkports' => $endb,
                            'ntas_networkports'              => 'id',
                        ],
                    ],
                ],
                'WHERE'        => [
                    'ntas_networkports_networkports.' . $enda   => new QuerySubQuery([
                        'SELECT' => 'id',
