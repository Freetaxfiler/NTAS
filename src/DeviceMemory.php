...
class DeviceMemory extends CommonDevice
{
            ...
            case 'Computer':
                ...
                if ($this->fields["devicememorytypes_id"]) {
                    $row->addCell(
                        ...
                        htmlescape(Dropdown::getDropdownName("ntas_devicememorytypes", $this->fields["devicememorytypes_id"])),
                        $father
                    );
                }
    ...
    public static function rawSearchOptionsToAdd($class, $main_joinparams)
    {
        ...
        $tab[] = [
            ...
            'joinparams'         => [
                'beforejoin'         => [
                    'table'              => 'ntas_items_devicememories',
