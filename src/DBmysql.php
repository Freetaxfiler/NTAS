...
class DBmysql
{
    ...
    public function __construct($choice = null)
    {
        ...
        // Second runner will use `ntas_2`
        // Third runner will use `ntas_3`
        // And so on...
    ...
    public function doQuery($query)
    {
        ...
        if (isset($_SESSION['ntas_use_mode']) && ($_SESSION['ntas_use_mode'] == Session::DEBUG_MODE)) {
     ...
     *
     * @param string $table Table name condition (ntas_% as default to retrieve only glpi tables)
