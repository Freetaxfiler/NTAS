...
switch ($type) {
    ...
    case "itilcategories_id":
        ...
        $title   = sprintf(
            ...
            Dropdown::getDropdownName("ntas_itilcategories", $_GET["id"])
        );
    ...
    case 'locations_id':
        ...
        $title   = sprintf(
            ...
            Dropdown::getDropdownName('ntas_locations', $_GET['id'])
        );
        $title   = htmlescape($title);
        break;
    ...
    case "group":
        ...
        $title   = sprintf(
            __('%1$s: %2$s'),
            Group::getTypeName(1),
            Dropdown::getDropdownName("ntas_groups", $_GET["id"])
        );
        $title   = htmlescape($title);
        break;
    ...
    case "usertitles_id":
        ...
        $title   = sprintf(
            __('%1$s: %2$s'),
            _x('person', 'Title'),
            Dropdown::getDropdownName("ntas_usertitles", $_GET["id"])
        );
        $title   = htmlescape($title);
        break;
    ...
    case "solutiontypes_id":
        ...
        $title   = sprintf(
            ...
            Dropdown::getDropdownName("ntas_solutiontypes", $_GET["id"])
        );
        $title   = htmlescape($title);
        break;
    ...
    case "usercategories_id":
        ...
        $title   = sprintf(
            __('%1$s: %2$s'),
            _n('Category', 'Categories', 1),
            Dropdown::getDropdownName("ntas_usercategories", $_GET["id"])
        );
        $title   = htmlescape($title);
        break;
    ...
    case "requesttypes_id":
        ...
        $title   = sprintf(
            ...
            Dropdown::getDropdownName("ntas_requesttypes", $_GET["id"])
        );
        $title   = htmlescape($title);
        break;
