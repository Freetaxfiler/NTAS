 ...
 */
var ntas_close_all_dialogs = function() {
 ...
 */
const ntas_toast = (title, message, css_class, options = {}) => {
    toast_id++;
 ...
 * @param {ToastOptions} options Toast options
 */
const ntas_toast_success = (message, caption = undefined, options = {}) => {
    ntas_toast(caption || __('Success'), message, 'bg-success text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const ntas_toast_info = function(message, caption = undefined, options = {}) {
    ntas_toast(caption || _n("Information", "Information", 1), message, 'bg-info text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const ntas_toast_warning = (message, caption = undefined, options = {}) => {
    ntas_toast(caption || __('Warning'), message, 'bg-warning text-white border-0', options);
};
 ...
 * @param {ToastOptions} options Toast options
 */
const ntas_toast_error = (message, caption = undefined, options = {}) => {
    ntas_toast(caption || _n('Error', 'Errors', 1), message, 'bg-danger text-white border-0', options);
};
