...
/* global _, tinymce_editor_configs, getUUID, sortable, tinymce, ntas_toast_info, ntas_toast_error, bootstrap, setupAjaxDropdown, setupAdaptDropdown, setHasUnsavedChanges, hasUnsavedChanges */
...
export class GlpiFormEditorController
{
    ...
    #initEventHandlers() {
        ...
        $(this.#target).on('submit', (event) => {
            try {
                ...
                ntas_toast_error(__("An unexpected error occurred"));
                throw e;
            }
        });
    ...
    #copyQuestionUuidToClipboard(question) {
        ...
        ntas_toast_info(__("UUID copied successfully to clipboard."));
    }
