...
/* global ntas_ajax_dialog, ntas_close_all_dialogs, ntas_toast_info, ntas_toast_error */
    ...
    constructor(params) {
        ...
        $(document).on('click', 'button[name="confirm-reset-dashboard"]', (event) => {
            ...
            $.ajax({
                ...
                ntas_toast_info(__('Dashboard has been reset to default'));
                if (window.reloadTab !== undefined) {
                    window.ntas_close_all_dialogs();
                    window.reloadTab();
                } else {
                    this.initFilters();
                    this.refreshDashboard();
                ...
                ntas_toast_error(__('An error occurred while resetting the dashboard'));
                ntas_close_all_dialogs();
            });
        });
