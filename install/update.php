...
function showSecurityKeyCheckForm(): void
{
    ...
    echo Html::hidden('_ntas_csrf_token', ['value' => Session::getNewCSRFToken()]);
...
if (($_SESSION['can_process_update'] ?? false) === false) {
    ...
    if ($DB->connected) {
        ...
        if (
            ...
            echo '<div id="ntas_update_messages_container"></div>';

            echo '<div class="text-center">';
            echo '<div id="ntas_update_success" class="d-none">';
