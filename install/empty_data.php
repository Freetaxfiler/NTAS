...
$empty_data_builder = new class {
    ...
    public function getEmptyData(): array
    {
        ...
        $default_prefs = [
            ...
            'impact_assets_list' => '[]',
            'timezone' => '0',
            'ntas_11_form_migration' => 0,
            'ntas_11_assets_migration' => 0,
        ...
        $tables['ntas_dashboards_dashboards'] = [];
        $tables['ntas_dashboards_items'] = [];
        $i = $j = 1;
        foreach (Dashboard::getDefaults() as $dashboard_data) {
            ...
            foreach ($dashboard_data['items'] as $item) {
                ...
                $tables['ntas_dashboards_items'][] = $item;
        ...
        $tables['ntas_devicesimcardtypes'] = [
            [
                'id' => 1,
                'name' => 'Full SIM',
            ],
        ...
        $tables['ntas_displaypreferences'] = [
            [
                'itemtype' => 'Computer',
                'num' => '4',
                'rank' => '4',
        ...
        // more maintainable...
        foreach (array_keys($tables['ntas_displaypreferences']) as $index) {
            $tables['ntas_displaypreferences'][$index]['interface'] = 'central';
        }
        ...
        $tables['ntas_notifications_notificationtemplates'] = [
            [
                'id' => 1,
                'notifications_id' => '1',
                'mode' => 'mailing',
        ...
        $tables['ntas_notificationtargets'] = [
            [
                'id' => '1',
                'items_id' => '3',
                'type' => '1',
        ...
        $tables['ntas_notificationtemplates'] = [
            [
                'id' => '1',
                'name' => 'MySQL Synchronization',
                'itemtype' => 'DBConnection',
        ...
        $tables['ntas_notificationtemplatetranslations'] = [
            [
                'id' => '1',
                'notificationtemplates_id' => '1',
                'language' => '',
...
&lt;p&gt;##lang.target.url## : ##target.url##&lt;/p&gt; ##ENDFOREACHtargets##',
        ...
        $tables['ntas_rulerightparameters'] = [
            [
                'id' => 1,
        ...
        $tables['ntas_softwarecategories'] = [
            [
                'id' => '1',
                'name' => 'Inventoried',
        ...
        $tables['ntas_softwarelicensetypes'] = [
            [
                'id' => 1,
                'name' => 'OEM',
                'is_recursive' => 1,
        ...
        // allowed_statuses is set using default value, @see install/mysql/glpi-empty.sql ( table `ntas_tickettemplates` )
        $tables['ntas_tickettemplates'] = [
            [
                'id' => 1,
                'name' => 'Default',
                'entities_id' => 0,
        ...
        $tables['ntas_tickettemplatemandatoryfields'] = [
            [
                'id' => 1,
                'tickettemplates_id' => 1,
                'num' => 21,
        ...
        $tables['ntas_changetemplatemandatoryfields'] = [
            [
                'id' => 1,
                'changetemplates_id' => 1,
                'num' => 21,
        ...
        $tables['ntas_problemtemplatemandatoryfields'] = [
            [
                'id' => 1,
                'problemtemplates_id' => 1,
                'num' => 21,
        ...
        $tables['ntas_devicefirmwaretypes'] = [
            [
                'id' => '1',
                'name' => 'BIOS',
            ],
        ...
        $root_entity = array_filter($tables['ntas_entities'], static fn($e) => $e['id'] === 0);
        ...
        if ($add_cypress_data) {
            ...
            $tables['ntas_entities'][] = $e2e_entity;
            ...
            $tables['ntas_entities'][] = $e2e_subentity1;
            ...
            $tables['ntas_entities'][] = $e2e_subentity2;

            // New e2e super-admin user (login: e2e_tests, password: glpi)
            $default_ntas_user = array_filter($tables['ntas_users'], static fn($u) => $u['id'] === self::USER_GLPI);
            $e2e_user = array_shift($default_ntas_user);
            ...
            $e2e_parent_entity_id = max(
                array_column($tables['ntas_entities'], 'id')
            ) + 1;
            ...
            $tables['ntas_entities'][] = $e2e_parent_entity;
            ...
            foreach ($sub_entities_to_create as $entity) {
                ...
                $tables['ntas_entities'][] = $subentity;
            }

            // // Create required users
            $default_ntas_user = array_filter(
                $tables['ntas_users'],
                static fn($u) => $u['id'] === self::USER_GLPI
            );
            $default_ntas_user = array_shift($default_ntas_user);
            ...
            foreach ($users_to_create as $user_data) {
                $next_available_user_id = max(
                    array_column($tables['ntas_users'], 'id')
                ) + 1;
                $user = array_replace($default_ntas_user, [
