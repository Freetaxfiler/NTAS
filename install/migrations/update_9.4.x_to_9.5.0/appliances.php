 ...
 */
if (!$DB->tableExists('ntas_appliances')) {
    $query = "CREATE TABLE `ntas_appliances` (
...
if (!$DB->tableExists('ntas_appliances_items')) {
    $query = "CREATE TABLE `ntas_appliances_items` (
         `id` int NOT NULL auto_increment,
...
if (!$DB->tableExists('ntas_appliancetypes')) {
    $query = "CREATE TABLE `ntas_appliancetypes` (
         `id` int NOT NULL auto_increment,
         `entities_id` int NOT NULL default '0',
         `is_recursive` tinyint NOT NULL default '0',
         `name` varchar(255) NOT NULL default '',
...
if (!$DB->tableExists('ntas_applianceenvironments')) {
    $query = "CREATE TABLE `ntas_applianceenvironments` (
         `id` int NOT NULL auto_increment,
...
if (!$DB->tableExists('ntas_appliancerelations')) {
    $query = "CREATE TABLE `ntas_appliancerelations` (
         `id` int NOT NULL auto_increment,
