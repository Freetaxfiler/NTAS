...
if (!$DB->tableExists('ntas_devicecameras')) {
    $query = "CREATE TABLE `ntas_devicecameras` (
    ...
    $migration->dropKey('ntas_devicecameras', 'unicity');
    $migration->addKey('ntas_devicecameras', 'manufacturers_id', 'manufacturers_id');
}

if (!$DB->tableExists('ntas_devicecameramodels')) {
    $query = "CREATE TABLE `ntas_devicecameramodels` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
...
if (!$DB->tableExists('ntas_imageformats')) {
    $query = "CREATE TABLE `ntas_imageformats` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
      `name` varchar(255) DEFAULT NULL,
      `date_mod` timestamp NULL DEFAULT NULL,
      `comment` text,
...
if (!$DB->tableExists('ntas_imageresolutions')) {
    $query = "CREATE TABLE `ntas_imageresolutions` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
      `name` varchar(255) DEFAULT NULL,
...
if (!$DB->tableExists('ntas_items_devicecameras')) {
    $query = "CREATE TABLE `ntas_items_devicecameras` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
...
if (!$DB->tableExists('ntas_items_devicecameras_imageformats')) {
    $query = "CREATE TABLE `ntas_items_devicecameras_imageformats` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
...
if (!$DB->tableExists('ntas_items_devicecameras_imageresolutions')) {
    $query = "CREATE TABLE `ntas_items_devicecameras_imageresolutions` (
      `id` int {$default_key_sign} NOT NULL AUTO_INCREMENT,
      `item_devicecameras_id` int {$default_key_sign} NOT NULL DEFAULT '0',
