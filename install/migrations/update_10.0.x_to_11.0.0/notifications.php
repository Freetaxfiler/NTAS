...
$notification_exists = countElementsInTable('ntas_notifications', ['itemtype' => 'User', 'event' => 'passwordinit']) > 0;
...
if (countElementsInTable('ntas_notifications', ['itemtype' => 'Change', 'event' => 'satisfaction']) === 0) {
    $DB->insert(
        'ntas_notificationtemplates',
        [
...
if (countElementsInTable('ntas_notifications', ['itemtype' => 'Ticket', 'event' => 'auto_reminder']) === 0) {
    $DB->insert('ntas_notificationtemplates', [
    ...
    $DB->insert('ntas_notificationtemplatetranslations', [
        'notificationtemplates_id' => $notificationtemplate_id,
        'language' => '',
...
$migration->addField("ntas_notifications", "attach_documents", "tinyint NOT NULL DEFAULT '-2'");
...
$migration->addField("ntas_queuednotifications", "itemtype_trigger", "varchar(255) DEFAULT NULL");
$migration->addField("ntas_queuednotifications", "items_id_trigger", "fkey");
$migration->addKey(
    "ntas_queuednotifications",
...
$migration->addField('ntas_notificationtargets', 'is_exclusion', 'boolean');
$migration->addKey('ntas_notificationtargets', ['is_exclusion'], 'is_exclusion');
