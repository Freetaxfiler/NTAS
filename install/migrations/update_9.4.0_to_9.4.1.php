...
function update940to941()
{
    ...
    if (countElementsInTable('ntas_displaypreferences', ['num' => '2', 'itemtype' => 'Profile'])) {
    ...
    if (!$DB->fieldExists('ntas_users', 'cookie_token')) {
        $migration->addField('ntas_users', 'cookie_token', 'string', ['after' => 'api_token_date']);
        $migration->addField('ntas_users', 'cookie_token_date', 'datetime', ['after' => 'cookie_token']);
    }
