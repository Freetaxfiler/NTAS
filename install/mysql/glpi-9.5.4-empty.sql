...
CREATE TABLE `ntas_certificates` (
  ...
  `is_template` tinyint(1) NOT NULL DEFAULT '0',
  `template_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `certificatetypes_id` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to ntas_certificatetypes (id)',
  `dns_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dns_suffix` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `users_id_tech` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to ntas_users (id)',
  `groups_id_tech` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to ntas_groups (id)',
  `locations_id` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to ntas_locations (id)',
  `manufacturers_id` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to ntas_manufacturers (id)',
...
### Dump table ntas_computerantiviruses

DROP TABLE IF EXISTS `ntas_computerantiviruses`;
CREATE TABLE `ntas_computerantiviruses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ntas_devicesimcards` (
   `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ntas_items_devicesimcards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `items_id` int(11) NOT NULL DEFAULT '0' COMMENT 'RELATION to various table, according to itemtype (id)',
  `itemtype` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ntas_devicesimcardtypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ntas_lineoperators` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `comment` text COLLATE utf8_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `ntas_linetypes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comment` text COLLATE utf8_unicode_ci,
  `date_mod` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `ntas_pdus_plugs`;
CREATE TABLE `ntas_pdus_plugs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ntas_appliances_items` (
   `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `ntas_appliancetypes` (
   `id` int(11) NOT NULL auto_increment,
   `entities_id` int(11) NOT NULL DEFAULT '0',
   `is_recursive` tinyint(1) NOT NULL DEFAULT '0',
   `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ntas_applianceenvironments` (
   `id` int(11) NOT NULL auto_increment,
   `name` varchar(255) DEFAULT NULL,
   `comment` text,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ntas_appliances_items_relations` (
   `id` int(11) NOT NULL auto_increment,
